...
public class RepertoarUpdate {
    ...
    public RepertoarUpdate(String film, String reziser, String zanr, Integer trajanje, Double ocena, String projekcija, Double cenaKarte) {
        this.film = film;
    ...
    public RepertoarUpdate(Long idRepertoar, String film, String reziser, String zanr, Integer trajanje, Double ocena, String projekcija, Double cenaKarte) {
